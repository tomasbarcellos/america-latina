...
shinyUI(fluidPage(
  ...
  tabsetPanel(
    ...
    tabPanel("Precos", value = 3,
             helpText("Esta mostra dados dos precos internacionais 
                      das princiapais mercadorias vendidads por paises latino-americanos")),
  ...
  HTML('<footer align = "center"> <p><img src="www/logo-mini.jpg">Este painel foi criado pelo <a href = "http://iela.ufsc.br">Instituto de Estudos Latino-Americanos</a> (IELA).</p>
      <p>Acesse o link deste projeto no <a href = "https://github.com/tomasbarcellos/Painel-AL/">GitHub</a>.</p><footer>')
))